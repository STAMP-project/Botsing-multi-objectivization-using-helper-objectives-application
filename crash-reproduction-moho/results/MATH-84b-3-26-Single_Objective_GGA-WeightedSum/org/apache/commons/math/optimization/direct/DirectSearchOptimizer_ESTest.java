...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MultiDirectional multiDirectional0 = new MultiDirectional(162.344532630727, 0.431);
      multiDirectional0.setMaxIterations((-1540));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-1,540) exceeded
         //
