...
public class ModelScriptService_ESTest extends ModelScriptService_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      modelScriptService0.resolveSpace("Deprecated usage of DocumentReferenceResolver with hint [{}]. Please consider using a DocumentReferenceResolver that takes into account generic types.", "Deprecated usage of DocumentReferenceResolver with hint [{}]. Please consider using a DocumentReferenceResolver that takes into account generic types.", objectArray0);
  }
}
