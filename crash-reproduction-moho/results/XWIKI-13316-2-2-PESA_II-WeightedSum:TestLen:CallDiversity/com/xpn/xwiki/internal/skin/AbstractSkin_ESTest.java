...
public class AbstractSkin_ESTest extends AbstractSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("An Exception occurred while trying to look up a target DataSource via JNDI!", internalSkinManager0, internalSkinConfiguration0, logger0, defaultSyntaxFactory0, (Environment) null, readOnlyXWikiContextProvider0);
