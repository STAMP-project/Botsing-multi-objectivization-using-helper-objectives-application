...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(Double.NaN, 0.0).when(multivariateRealFunction0).value(any(double[].class));
      multiDirectional0.setMaxIterations((-135));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-135) exceeded
         //
