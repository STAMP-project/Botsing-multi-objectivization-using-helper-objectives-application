...
public class JarExtensionHandler_ESTest extends JarExtensionHandler_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(linkedList0).when(request0).getId();
      doReturn(linkedList0).when(request0).getPropertyNames();
      DefaultRequest defaultRequest0 = new DefaultRequest(request0);
      // Undeclared exception!
      jarExtensionHandler0.uninstall(installedExtension0, "57Cw`6Io~:uWmR", (Request) defaultRequest0);
  }
}
