...
public class DefaultWikiTemplateManager_ESTest extends DefaultWikiTemplateManager_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      WikiDescriptor wikiDescriptor0 = new WikiDescriptor(";\"%{%f2T`;9%rO", ";\"%{%f2T`;9%rO");
      ...
      Provider<ImageBlock> provider0 = (Provider<ImageBlock>) mock(Provider.class, new ViolatedAssumptionAnswer());
      // Undeclared exception!
      defaultWikiTemplateManager0.setTemplate(";\"%{%f2T`;9%rO", false);
  }
}
