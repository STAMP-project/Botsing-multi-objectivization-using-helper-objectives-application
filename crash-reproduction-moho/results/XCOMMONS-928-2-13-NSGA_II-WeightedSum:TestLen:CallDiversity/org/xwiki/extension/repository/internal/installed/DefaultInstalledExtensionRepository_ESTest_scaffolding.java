...
public class DefaultInstalledExtensionRepository_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.slf4j.Logger", false, DefaultInstalledExtensionRepository_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.extension.LocalExtension", false, DefaultInstalledExtensionRepository_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.extension.repository.CoreExtensionRepository", false, DefaultInstalledExtensionRepository_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.extension.repository.LocalExtensionRepository", false, DefaultInstalledExtensionRepository_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xwiki.extension.wrap.WrappingInstalledExtension", false, DefaultInstalledExtensionRepository_ESTest_scaffolding.class.getClassLoader()));
  }
}
