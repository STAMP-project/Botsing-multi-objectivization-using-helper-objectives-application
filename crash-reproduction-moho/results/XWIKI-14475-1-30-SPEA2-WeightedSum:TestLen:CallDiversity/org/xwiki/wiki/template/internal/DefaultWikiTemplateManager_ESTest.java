...
public class DefaultWikiTemplateManager_ESTest extends DefaultWikiTemplateManager_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      WikiDescriptor wikiDescriptor0 = new WikiDescriptor("g;(6-kT~Cm{H)sr(K", "g;(6-kT~Cm{H)sr(K");
      ...
      defaultWikiTemplateManager0.setTemplate("Failed to get the descriptor for [%s].", true);
  }
}
