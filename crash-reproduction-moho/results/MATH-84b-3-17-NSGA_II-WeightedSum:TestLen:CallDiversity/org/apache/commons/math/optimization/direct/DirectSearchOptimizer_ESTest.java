...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MultiDirectional multiDirectional0 = new MultiDirectional((-625.17436988), 1494.0);
      multiDirectional0.setMaxIterations(286);
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (286) exceeded
         //
