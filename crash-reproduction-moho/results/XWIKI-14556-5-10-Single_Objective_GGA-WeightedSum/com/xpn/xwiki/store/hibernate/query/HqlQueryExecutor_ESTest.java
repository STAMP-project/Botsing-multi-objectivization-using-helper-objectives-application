...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ManyToOneType manyToOneType0 = new ManyToOneType(typeFactory_TypeScope0, "!7zd?3n");
      ForeignKeyDirection foreignKeyDirection0 = manyToOneType0.getForeignKeyDirection();
      OneToOneType oneToOneType0 = new OneToOneType(typeFactory_TypeScope0, "!7zd?3n", foreignKeyDirection0, ",,all", true, true, true, "!7zd?3n", "72@-q6!>}kBUl9wjCC");
      OrdinalParameterDescriptor ordinalParameterDescriptor0 = new OrdinalParameterDescriptor(15, oneToOneType0, 15);
      ParameterMetadata parameterMetadata0 = new ParameterMetadata(ordinalParameterDescriptorArray0, xWikiContext0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("!7zd?3n", xWikiContext0, sessionImplementor0, parameterMetadata0);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(collectionFilterImpl0, "72@-q6!>}kBUl9wjCC", ordinalParameterDescriptor0);
  }
}
