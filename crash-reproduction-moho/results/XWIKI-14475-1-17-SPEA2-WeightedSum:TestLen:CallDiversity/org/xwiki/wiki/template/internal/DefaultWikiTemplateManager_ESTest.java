...
public class DefaultWikiTemplateManager_ESTest extends DefaultWikiTemplateManager_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      WikiDescriptor wikiDescriptor0 = new WikiDescriptor("Access denied; user {0}, acting through script in document {1} cannot save document {2}", "Access denied; user {0}, acting through script in document {1} cannot save document {2}");
