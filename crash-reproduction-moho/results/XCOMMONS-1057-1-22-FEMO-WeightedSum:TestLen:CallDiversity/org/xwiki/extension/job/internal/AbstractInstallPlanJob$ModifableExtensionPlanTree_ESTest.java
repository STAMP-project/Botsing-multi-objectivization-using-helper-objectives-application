...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ExtensionId extensionId0 = new ExtensionId("Z{W>wt'k<V");
      EmptyExtension emptyExtension0 = new EmptyExtension(extensionId0, ";f`:Qb^QfG#=D$");
      ...
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, priorityQueue0, extensionPlanAction_Action0, "DJ]jS.$1UU", false);
      DefaultVersion defaultVersion0 = new DefaultVersion("Z{W>wt'k<V");
