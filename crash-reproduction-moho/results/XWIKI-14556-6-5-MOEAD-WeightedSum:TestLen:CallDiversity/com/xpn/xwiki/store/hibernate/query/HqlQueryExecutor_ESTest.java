...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("select do", hqlQueryExecutor0);
      Query query0 = defaultQuery0.bindValue("select do", (Object) defaultQuery0);
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      OrdinalParameterDescriptor[] ordinalParameterDescriptorArray0 = new OrdinalParameterDescriptor[1];
      HashMap<NoOpQueryFilter, RootComponentManager> hashMap0 = new HashMap<NoOpQueryFilter, RootComponentManager>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata(ordinalParameterDescriptorArray0, hashMap0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("select do", query0, sessionImplementor0, parameterMetadata0);
