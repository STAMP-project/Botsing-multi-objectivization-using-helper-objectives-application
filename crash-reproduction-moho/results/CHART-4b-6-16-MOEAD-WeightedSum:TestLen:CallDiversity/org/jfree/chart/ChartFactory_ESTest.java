...
public class ChartFactory_ESTest extends ChartFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(1028).when(xYDataset0).getSeriesCount();
      ...
      ChartFactory.createScatterPlot("hZOK~`z=8a`2u)x-P", "MSung-Light", "hZOK~`z=8a`2u)x-P", xYDataset0, plotOrientation0, true, true, true);
  }
}
