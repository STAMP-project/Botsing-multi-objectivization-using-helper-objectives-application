...
public class EventState_ESTest extends EventState_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-1343.4799810463155), 0.0, 0.0).when(eventHandler0).g(anyDouble() , any(double[].class));
      EventState eventState0 = new EventState(eventHandler0, 0.5, 465.5826744232555, 2);
      double[] doubleArray0 = new double[5];
      StepInterpolator stepInterpolator0 = mock(StepInterpolator.class, new ViolatedAssumptionAnswer());
      doReturn(0.5).when(stepInterpolator0).getCurrentTime();
