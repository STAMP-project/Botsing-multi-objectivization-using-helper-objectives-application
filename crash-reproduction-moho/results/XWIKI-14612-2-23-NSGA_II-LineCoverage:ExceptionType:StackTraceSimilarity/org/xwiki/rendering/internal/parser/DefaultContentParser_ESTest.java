...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EmbeddableComponentManager embeddableComponentManager0 = mock(EmbeddableComponentManager.class, new ViolatedAssumptionAnswer());
      doReturn((Object) null).when(embeddableComponentManager0).getInstance(any(java.lang.reflect.Type.class) , anyString());
      ...
      doReturn("org.apache.commons.logging.simplelog.showlogname").when(syntax0).toIdString();
      EntityReference entityReference0 = mock(EntityReference.class, new ViolatedAssumptionAnswer());
      // Undeclared exception!
      defaultContentParser0.parse("~-]D)r-p:K0P\"V~KS", syntax0, entityReference0);
  }
}
