...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ExtensionId extensionId0 = new ExtensionId("%xjiLkHk/", "u2y6[+FGwGuCKNxjI");
      ...
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, linkedList0, extensionPlanAction_Action0, "u2y6[+FGwGuCKNxjI", true);
      DefaultVersionConstraint defaultVersionConstraint0 = new DefaultVersionConstraint("%xjiLkHk/");
