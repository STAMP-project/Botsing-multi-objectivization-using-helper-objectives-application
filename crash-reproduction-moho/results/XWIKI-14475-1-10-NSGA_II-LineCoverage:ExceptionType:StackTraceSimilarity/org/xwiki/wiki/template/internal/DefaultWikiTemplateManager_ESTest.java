...
public class DefaultWikiTemplateManager_ESTest extends DefaultWikiTemplateManager_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      WikiDescriptor wikiDescriptor0 = new WikiDescriptor("from doc.object(WikiManager.WikiTemplateClass) as descriptor where doc.name like 'XWikiServer%' and descriptor.iswikitemplate = 1", "from doc.object(WikiManager.WikiTemplateClass) as descriptor where doc.name like 'XWikiServer%' and descriptor.iswikitemplate = 1");
      ...
      defaultWikiTemplateManager0.setTemplate("A0<n}55={Lg2", false);
  }
}
