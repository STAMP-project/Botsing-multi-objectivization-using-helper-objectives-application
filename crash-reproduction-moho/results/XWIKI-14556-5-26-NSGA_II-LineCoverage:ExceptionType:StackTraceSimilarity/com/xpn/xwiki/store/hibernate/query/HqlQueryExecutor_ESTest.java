...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AtomicHashMap<ContextComponentManager, NamedSQLQueryDefinition> atomicHashMap0 = new AtomicHashMap<ContextComponentManager, NamedSQLQueryDefinition>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, atomicHashMap0);
      QueryImpl queryImpl0 = new QueryImpl("removed in doubt xid: %s", flushMode0, sessionImplementor0, parameterMetadata0);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(queryImpl0, "order by 1pbphiez", "removed in doubt xid: %s");
  }
}
