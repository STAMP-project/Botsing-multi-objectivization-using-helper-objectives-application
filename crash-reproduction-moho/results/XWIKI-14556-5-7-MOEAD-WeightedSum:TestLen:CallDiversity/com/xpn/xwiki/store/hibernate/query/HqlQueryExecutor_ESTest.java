...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("Failed to locate [%s] Query Filter", hqlQueryExecutor0, sessionImplementor0, parameterMetadata0);
      LanguageQueryFilter languageQueryFilter0 = new LanguageQueryFilter();
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(collectionFilterImpl0, "Failed to locate [%s] Query Filter", languageQueryFilter0);
  }
}
