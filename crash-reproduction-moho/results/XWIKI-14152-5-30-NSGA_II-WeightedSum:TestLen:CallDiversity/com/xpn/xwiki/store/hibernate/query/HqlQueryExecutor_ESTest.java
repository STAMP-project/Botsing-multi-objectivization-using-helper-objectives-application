...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("Lost segments %s during rehash for id %s", "Lost segments %s during rehash for id %s", hqlQueryExecutor0);
