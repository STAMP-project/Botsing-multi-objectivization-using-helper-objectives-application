...
public class EventState_ESTest extends EventState_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-1279.8590027), 0.0, 0.0).when(eventHandler0).g(anyDouble() , any(double[].class));
      EventState eventState0 = new EventState(eventHandler0, Double.NaN, Double.NaN, 1242);
      ...
      assertTrue(boolean0);
      assertEquals(1242, eventState0.getMaxIterationCount());
  }
}
