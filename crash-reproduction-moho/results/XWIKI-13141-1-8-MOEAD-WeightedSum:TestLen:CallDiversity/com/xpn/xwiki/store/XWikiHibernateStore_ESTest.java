...
public class XWikiHibernateStore_ESTest extends XWikiHibernateStore_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DocumentReferenceResolver<IntegerProperty> documentReferenceResolver1 = (DocumentReferenceResolver<IntegerProperty>) mock(DocumentReferenceResolver.class, new ViolatedAssumptionAnswer());
      ...
      Float float0 = new Float(810.3318F);
      ...
      doReturn(float0).when(entityReferenceSerializer1).serialize(any(org.xwiki.model.reference.EntityReference.class) , any(java.lang.Object[].class));
      ...
      doReturn("Exception while loading object '{0}' of class '{1}' and number '{2}'").when(xWikiDocument0).getComment();
