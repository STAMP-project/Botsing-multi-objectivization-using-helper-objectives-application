...
public class JarExtensionHandler_ESTest extends JarExtensionHandler_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(true).when(wrappingInstalledExtension0).isValid(anyString());
      // Undeclared exception!
      jarExtensionHandler0.uninstall((InstalledExtension) wrappingInstalledExtension0, "Failed to unregister some components of the JAR extension [{}]", (Request) null);
  }
}
