...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MultiDirectional multiDirectional0 = new MultiDirectional(148, 1248.845);
      multiDirectional0.setMaxIterations(39);
      try { 
        multiDirectional0.optimize(multivariateRealFunction0, goalType0, doubleArray0[0]);
        fail("Expecting exception: OptimizationException");
      
      } catch(OptimizationException e) {
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (39) exceeded
         //
