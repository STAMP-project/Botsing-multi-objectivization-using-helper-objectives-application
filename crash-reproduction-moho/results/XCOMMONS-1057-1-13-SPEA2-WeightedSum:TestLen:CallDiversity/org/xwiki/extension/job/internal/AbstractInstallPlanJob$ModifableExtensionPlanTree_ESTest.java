...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultVersion defaultVersion0 = new DefaultVersion("cgw@<K+f[\"cq6V~");
      ExtensionId extensionId0 = new ExtensionId("cgw@<K+f[\"cq6V~", defaultVersion0);
      EmptyExtension emptyExtension0 = new EmptyExtension(extensionId0, "}E,#01\")}V");
      ...
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, linkedList0, extensionPlanAction_Action0, "cgw@<K+f[\"cq6V~", true);
      DefaultVersionConstraint defaultVersionConstraint0 = new DefaultVersionConstraint("}E,#01\")}V");
