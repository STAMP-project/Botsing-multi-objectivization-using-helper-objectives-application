...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MultiDirectional multiDirectional0 = new MultiDirectional((-1556.35), (-1556.35));
      multiDirectional0.setMaxIterations((-2297));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-2,297) exceeded
         //
