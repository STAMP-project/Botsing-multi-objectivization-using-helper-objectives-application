...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-1901.0), Double.NaN, 0.0, 0.0, (-1901.0)).when(multivariateRealFunction0).value(any(double[].class));
      MultiDirectional multiDirectional0 = new MultiDirectional();
      GoalType goalType0 = GoalType.MAXIMIZE;
      double[] doubleArray0 = new double[5];
      multiDirectional0.setMaxIterations((-504));
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-504) exceeded
         //
