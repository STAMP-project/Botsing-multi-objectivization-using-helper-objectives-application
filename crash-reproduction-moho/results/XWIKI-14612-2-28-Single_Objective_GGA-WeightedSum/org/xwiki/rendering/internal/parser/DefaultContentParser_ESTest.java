...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EntityReferenceSerializer<DefinitionListBlock> entityReferenceSerializer0 = (EntityReferenceSerializer<DefinitionListBlock>) mock(EntityReferenceSerializer.class, new ViolatedAssumptionAnswer());
      ...
      DocumentReference documentReference0 = new DocumentReference("source", "2)\"#rL6dc", "2)\"#rL6dc", locale0);
      // Undeclared exception!
      defaultContentParser0.parse("Checking availability for key=%s, status=%s", syntax0, (EntityReference) documentReference0);
  }
}
