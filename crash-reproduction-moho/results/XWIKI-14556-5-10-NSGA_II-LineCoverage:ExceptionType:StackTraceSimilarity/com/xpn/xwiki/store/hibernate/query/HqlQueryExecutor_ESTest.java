...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("]hCoM~b\"1\"Qp=[h%-^B", hqlQueryExecutor0);
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      OrdinalParameterDescriptor[] ordinalParameterDescriptorArray0 = new OrdinalParameterDescriptor[0];
      Hashtable<RootComponentManager, DefaultTableModel> hashtable0 = new Hashtable<RootComponentManager, DefaultTableModel>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata(ordinalParameterDescriptorArray0, hashtable0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("]hCoM~b\"1\"Qp=[h%-^B", executionContext0, sessionImplementor0, parameterMetadata0);
      // Undeclared exception!
      hqlQueryExecutor0.setNamedParameter(collectionFilterImpl0, "]hCoM~b\"1\"Qp=[h%-^B", defaultQuery0);
  }
}
