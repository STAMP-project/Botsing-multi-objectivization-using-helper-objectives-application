...
public class AbstractSkin_ESTest extends AbstractSkin_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      EnvironmentSkin environmentSkin0 = new EnvironmentSkin("Failed to parse the syntax [{}] configured by the skin [{}].", internalSkinManager0, internalSkinConfiguration0, logger0, syntaxFactory0, (Environment) null, readOnlyXWikiContextProvider0);
