...
public class AbstractEstimator_ESTest extends AbstractEstimator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(271.0).when(weightedMeasurement0).getResidual();
      doReturn(2808.24071, 271.0, 1149.57, 1149.57).when(weightedMeasurement0).getWeight();
      simpleEstimationProblem0.addMeasurement(weightedMeasurement0);
      EstimatedParameter estimatedParameter0 = new EstimatedParameter("", (-1420.818729), true);
