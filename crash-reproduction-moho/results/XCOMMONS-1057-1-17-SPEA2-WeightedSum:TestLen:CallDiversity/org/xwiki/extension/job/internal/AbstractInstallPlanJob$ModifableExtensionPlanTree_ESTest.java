...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ExtensionId extensionId0 = new ExtensionId("q1')3w}yHQ1'b-{n:o");
      EmptyExtension emptyExtension0 = new EmptyExtension(extensionId0, "q1')3w}yHQ1'b-{n:o");
      ...
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, treeSet0, extensionPlanAction_Action0, "q1')3w}yHQ1'b-{n:o", true);
      DefaultVersion defaultVersion0 = new DefaultVersion("&`~]nmBOr$M`+YB5z d");
