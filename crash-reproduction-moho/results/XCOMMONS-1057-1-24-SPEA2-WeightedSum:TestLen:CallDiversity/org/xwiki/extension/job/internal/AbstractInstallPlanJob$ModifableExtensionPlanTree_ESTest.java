...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultVersion defaultVersion0 = new DefaultVersion("SortOrder.ASCENDING");
      ExtensionId extensionId0 = new ExtensionId("OIM#$#>0CVBPCBc(d>", defaultVersion0);
      EmptyExtension emptyExtension0 = new EmptyExtension(extensionId0, "-Z5_>>");
      ExtensionPlanAction.Action extensionPlanAction_Action0 = ExtensionPlanAction.Action.REPAIR;
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, (Collection<InstalledExtension>) null, extensionPlanAction_Action0, "OIM#$#>0CVBPCBc(d>", true);
