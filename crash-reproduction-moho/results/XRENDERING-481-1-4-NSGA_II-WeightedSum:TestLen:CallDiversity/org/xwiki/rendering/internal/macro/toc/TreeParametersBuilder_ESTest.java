...
public class TreeParametersBuilder_ESTest extends TreeParametersBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MacroBlock macroBlock0 = new MacroBlock("B:b{T", map0, "B:b{T", false);
      ...
      doReturn(1233).when(tocMacroParameters0).getDepth();
      doReturn("-inf").when(tocMacroParameters0).getReference();
      doReturn(tocMacroParameters_Scope0, (TocMacroParameters.Scope) null).when(tocMacroParameters0).getScope();
      doReturn(1233).when(tocMacroParameters0).getStart();
