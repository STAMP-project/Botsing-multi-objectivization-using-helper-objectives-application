...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      LinkedList<QueryFilter> linkedList0 = new LinkedList<QueryFilter>();
      ...
      SubstituteLogger substituteLogger0 = new SubstituteLogger(",'t7if2b2qro", arrayDeque0, false);
      ...
      linkedList0.add((QueryFilter) countDocumentFilter0);
      Query query0 = mock(Query.class, new ViolatedAssumptionAnswer());
      doReturn(linkedList0, linkedList0).when(query0).getFilters();
      doReturn("2^4Q{=?_Rs)y").when(query0).getStatement();
