...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((PoolableConnection) null).when(provider0).get();
      ...
      doReturn("attempt to initialize the cache twice").when(syntax0).toIdString();
      EntityReference entityReference0 = mock(EntityReference.class, new ViolatedAssumptionAnswer());
      // Undeclared exception!
      defaultContentParser0.parse("attempt to initialize the cache twice", syntax0, entityReference0);
  }
}
