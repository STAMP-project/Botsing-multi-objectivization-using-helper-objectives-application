...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DocumentComponentManager documentComponentManager0 = mock(DocumentComponentManager.class, new ViolatedAssumptionAnswer());
      doReturn((Object) null).when(documentComponentManager0).getInstance(any(java.lang.reflect.Type.class) , anyString());
      ...
      doReturn(documentComponentManager0).when(provider0).get();
      ...
      defaultContentParser0.parse("}\"oFo{%h,*", syntax0);
  }
}
