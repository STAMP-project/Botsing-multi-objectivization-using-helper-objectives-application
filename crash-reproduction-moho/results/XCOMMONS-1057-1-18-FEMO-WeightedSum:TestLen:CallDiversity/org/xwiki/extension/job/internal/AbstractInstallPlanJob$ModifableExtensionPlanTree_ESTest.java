...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ExtensionId extensionId0 = new ExtensionId("The [{}] listener is overwritting a previously registered listener [{}] since they both are registered under the same id [{}]. In the future consider removing a Listener first if you really want to register it again.", "");
      EmptyExtension emptyExtension0 = new EmptyExtension(extensionId0, "");
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, (Collection<InstalledExtension>) null, extensionPlanAction_Action0, "The [{}] listener is overwritting a previously registered listener [{}] since they both are registered under the same id [{}]. In the future consider removing a Listener first if you really want to register it again.", true);
