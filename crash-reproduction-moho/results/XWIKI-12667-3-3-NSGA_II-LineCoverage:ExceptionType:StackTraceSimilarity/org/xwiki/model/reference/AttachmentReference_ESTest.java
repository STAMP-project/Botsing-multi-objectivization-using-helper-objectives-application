...
public class AttachmentReference_ESTest extends AttachmentReference_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AttachmentReference attachmentReference0 = new AttachmentReference("An Entity Reference name cannot be null or empty", documentReference0);
      assertEquals("An Entity Reference name cannot be null or empty", attachmentReference0.getName());
  }
