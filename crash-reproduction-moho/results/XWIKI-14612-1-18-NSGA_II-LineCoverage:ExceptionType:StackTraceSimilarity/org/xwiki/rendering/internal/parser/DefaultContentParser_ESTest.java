...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((ContextRootComponentManager) null).when(provider0).get();
      ...
      doReturn("'[`?8X6%n-kS").when(syntax0).toIdString();
      // Undeclared exception!
      defaultContentParser0.parse("Cannot load internal resources from '", syntax0);
  }
}
