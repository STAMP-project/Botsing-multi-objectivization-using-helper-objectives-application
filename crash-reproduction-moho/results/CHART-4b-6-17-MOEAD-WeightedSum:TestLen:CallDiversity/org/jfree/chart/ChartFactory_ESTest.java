...
public class ChartFactory_ESTest extends ChartFactory_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(804).when(xYDataset0).getSeriesCount();
      ...
      ChartFactory.createScatterPlot("(l]=tR90", "(l]=tR90", "(l]=tR90", xYDataset0, plotOrientation0, true, true, true);
  }
}
