...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ArrayList<QueryFilter> arrayList0 = new ArrayList<QueryFilter>();
      ...
      arrayList0.add((QueryFilter) countDocumentFilter0);
      Query query0 = mock(Query.class, new ViolatedAssumptionAnswer());
      doReturn(arrayList0, arrayList0).when(query0).getFilters();
