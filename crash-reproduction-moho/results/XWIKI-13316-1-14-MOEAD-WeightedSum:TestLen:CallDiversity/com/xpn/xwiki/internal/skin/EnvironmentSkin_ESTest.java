  ...
  public void test0()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          Server server0 = new Server((-125886972));
          URI uRI0 = server0.getURI();
          URL uRL0 = uRI0.toURL();
          ...
          EnvironmentSkin environmentSkin0 = new EnvironmentSkin("Y;+d4{{&Q2%u-3_", internalSkinManager0, internalSkinConfiguration0, logger0, syntaxFactory0, environment0, provider0);
