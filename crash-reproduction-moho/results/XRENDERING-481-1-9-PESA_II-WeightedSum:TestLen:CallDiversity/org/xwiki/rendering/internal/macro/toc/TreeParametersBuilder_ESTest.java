...
public class TreeParametersBuilder_ESTest extends TreeParametersBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-5159)).when(tocMacroParameters0).getDepth();
      doReturn("8R").when(tocMacroParameters0).getReference();
      doReturn(tocMacroParameters_Scope0, tocMacroParameters_Scope0).when(tocMacroParameters0).getScope();
      doReturn((-1243)).when(tocMacroParameters0).getStart();
      ...
      MacroBlock macroBlock0 = new MacroBlock("$6M5-i*Rn{lY", hashMap0, true);
