...
public class TreeParametersBuilder_ESTest extends TreeParametersBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MetaDataBlock metaDataBlock0 = new MetaDataBlock(linkedList0, metaData0);
      ...
      doReturn((-174)).when(tocMacroParameters0).getDepth();
      doReturn("xTYWN").when(tocMacroParameters0).getReference();
      doReturn(tocMacroParameters_Scope0).when(tocMacroParameters0).getScope();
      doReturn((-174)).when(tocMacroParameters0).getStart();
      doReturn(false).when(tocMacroParameters0).isCustomStart();
      doReturn(true).when(tocMacroParameters0).isNumbered();
      Map<String, String> map0 = ZoneId.SHORT_IDS;
      MacroBlock macroBlock0 = new MacroBlock("xTYWN", map0, true);
