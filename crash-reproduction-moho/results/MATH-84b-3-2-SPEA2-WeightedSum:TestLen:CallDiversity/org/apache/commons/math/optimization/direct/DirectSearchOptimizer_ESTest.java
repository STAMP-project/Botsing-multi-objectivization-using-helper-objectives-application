...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      MultiDirectional multiDirectional0 = new MultiDirectional((-970.7506968059782), (-970.7506968059782));
      multiDirectional0.setMaxIterations((-686));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-686) exceeded
         //
