...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Vector<QueryFilter> vector0 = new Vector<QueryFilter>();
      ...
      vector0.add((QueryFilter) countDocumentFilter0);
      Query query0 = mock(Query.class, new ViolatedAssumptionAnswer());
      doReturn(vector0, vector0).when(query0).getFilters();
      doReturn("xwikicontext").when(query0).getStatement();
