...
public class EventState_ESTest extends EventState_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-2650.7914062), 0.0, 0.0).when(eventHandler0).g(anyDouble() , any(double[].class));
      EventState eventState0 = new EventState(eventHandler0, (-3100.919251298765), (-254.09), 0);
      ...
      assertEquals(254.09, eventState0.getConvergence(), 0.01);
      assertFalse(eventState0.stop());
      assertEquals((-3100.919251298765), eventState0.getMaxCheckInterval(), 0.01);
  }
}
