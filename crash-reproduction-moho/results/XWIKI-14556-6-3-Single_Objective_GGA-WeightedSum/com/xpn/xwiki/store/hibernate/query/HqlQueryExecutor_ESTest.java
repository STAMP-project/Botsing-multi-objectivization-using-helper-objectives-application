...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("ENr", hqlQueryExecutor0);
      defaultQuery0.bindValue("s:c:qM_:+");
      AtomicHashMap<NamedQueryDefinition, LanguageQueryFilter> atomicHashMap0 = new AtomicHashMap<NamedQueryDefinition, LanguageQueryFilter>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, atomicHashMap0);
      QueryImpl queryImpl0 = new QueryImpl("order by bo-(_48qpd0}6", (FlushMode) null, (SessionImplementor) null, parameterMetadata0);
