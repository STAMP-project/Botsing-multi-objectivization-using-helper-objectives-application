...
public class MultiDirectional_ESTest extends MultiDirectional_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      MultiDirectional multiDirectional0 = new MultiDirectional(383.61612, 383.61612);
      multiDirectional0.setMaxIterations((-1646));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (-1,646) exceeded
         //
