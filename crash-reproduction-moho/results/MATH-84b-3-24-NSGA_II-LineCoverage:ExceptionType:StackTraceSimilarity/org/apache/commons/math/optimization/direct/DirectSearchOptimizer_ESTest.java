...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-4995.16993)).when(multivariateRealFunction0).value(any(double[].class));
      multiDirectional0.setMaxIterations(2068);
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (2,068) exceeded
         //
