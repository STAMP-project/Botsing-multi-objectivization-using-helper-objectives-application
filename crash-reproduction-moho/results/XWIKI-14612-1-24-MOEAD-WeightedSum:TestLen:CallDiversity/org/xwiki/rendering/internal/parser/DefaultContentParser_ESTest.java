...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((ContextComponentManager) null).when(provider0).get();
      ...
      doReturn("~wHWD6Rz,x@X J\"p/5").when(syntax0).toIdString();
      // Undeclared exception!
      defaultContentParser0.parse("*kE#", syntax0, (EntityReference) null);
  }
}
