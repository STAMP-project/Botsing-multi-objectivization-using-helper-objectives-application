...
public class EventState_ESTest extends EventState_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(Double.NaN, 2.0779220779220777, Double.NaN, 2.0779220779220777, 2.0779220779220777).when(eventHandler0).g(anyDouble() , any(double[].class));
      EventState eventState0 = new EventState(eventHandler0, 0.0, (-411.8723965), (-1));
      double[] doubleArray0 = new double[3];
      eventState0.stepAccepted(0.0, doubleArray0);
      StepInterpolator stepInterpolator0 = mock(StepInterpolator.class, new ViolatedAssumptionAnswer());
      doReturn((-43.0)).when(stepInterpolator0).getCurrentTime();
