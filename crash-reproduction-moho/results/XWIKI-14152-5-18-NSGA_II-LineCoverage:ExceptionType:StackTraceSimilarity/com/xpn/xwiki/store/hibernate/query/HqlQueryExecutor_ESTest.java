...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("~{Wc~j%", "e4+", hqlQueryExecutor0);
      ...
      SubstituteLogger substituteLogger0 = new SubstituteLogger("f#in@owll", priorityQueue0, true);
