...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Stack<QueryFilter> stack0 = new Stack<QueryFilter>();
      ...
      LinkedTransferQueue<SubstituteLoggingEvent> linkedTransferQueue0 = new LinkedTransferQueue<SubstituteLoggingEvent>(arrayDeque0);
      SubstituteLogger substituteLogger0 = new SubstituteLogger((String) null, linkedTransferQueue0, false);
      ...
      stack0.add((QueryFilter) countDocumentFilter0);
      Query query0 = mock(Query.class, new ViolatedAssumptionAnswer());
      doReturn(stack0, stack0).when(query0).getFilters();
      doReturn("z^LJtb( ").when(query0).getStatement();
      doReturn(false).when(query0).isNamed();
