...
public class TreeParametersBuilder_ESTest extends TreeParametersBuilder_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(5).when(tocMacroParameters0).getDepth();
      doReturn("@gbhbAQGy").when(tocMacroParameters0).getReference();
      ...
      MacroBlock macroBlock0 = new MacroBlock("@gbhbAQGy", hashtable0, false);
