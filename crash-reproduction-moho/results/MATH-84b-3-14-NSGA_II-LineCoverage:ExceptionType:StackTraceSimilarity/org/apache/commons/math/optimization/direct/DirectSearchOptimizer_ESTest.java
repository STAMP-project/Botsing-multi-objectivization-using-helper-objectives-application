...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      multiDirectional0.setMaxIterations(831);
      MultivariateRealFunction multivariateRealFunction0 = mock(MultivariateRealFunction.class, new ViolatedAssumptionAnswer());
      doReturn((-19.138985429), (-19.138985429), (double)Integer.MAX_VALUE, (double)Integer.MAX_VALUE, (double)Integer.MAX_VALUE).when(multivariateRealFunction0).value(any(double[].class));
      ...
      try { 
        ...
        fail("Expecting exception: OptimizationException");
         ...
         //
         // org.apache.commons.math.MaxIterationsExceededException: Maximal number of iterations (831) exceeded
         //
