...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      WikiComponentManager wikiComponentManager0 = mock(WikiComponentManager.class, new ViolatedAssumptionAnswer());
      doReturn((Object) null).when(wikiComponentManager0).getInstance(any(java.lang.reflect.Type.class) , anyString());
      Provider<WikiComponentManager> provider0 = (Provider<WikiComponentManager>) mock(Provider.class, new ViolatedAssumptionAnswer());
      doReturn(wikiComponentManager0).when(provider0).get();
      ...
      defaultContentParser0.parse("_)tR3,f]S4", syntax0);
  }
}
