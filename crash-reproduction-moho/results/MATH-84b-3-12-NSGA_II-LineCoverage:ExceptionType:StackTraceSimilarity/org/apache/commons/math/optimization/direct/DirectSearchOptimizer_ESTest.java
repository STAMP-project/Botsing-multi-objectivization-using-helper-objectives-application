...
public class DirectSearchOptimizer_ESTest extends DirectSearchOptimizer_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-1.0), (-1.0), (-1.0), (-1.0), 4838.302849).when(multivariateRealFunction0).value(any(double[].class));
      GoalType goalType0 = GoalType.MAXIMIZE;
      double[][] doubleArray0 = new double[5][6];
      MultiDirectional multiDirectional0 = new MultiDirectional(1.0, (-1.0));
      multiDirectional0.setMaxIterations(38);
      try { 
        multiDirectional0.optimize(multivariateRealFunction0, goalType0, doubleArray0[2]);
