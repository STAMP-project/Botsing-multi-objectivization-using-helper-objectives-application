...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Provider<ExtendedUUID> provider1 = (Provider<ExtendedUUID>) mock(Provider.class, new ViolatedAssumptionAnswer());
      ...
      Provider<EscapeLikeParametersFilter> provider2 = (Provider<EscapeLikeParametersFilter>) mock(Provider.class, new ViolatedAssumptionAnswer());
      ...
      DefaultQuery defaultQuery0 = new DefaultQuery("=de) by oy|_{bq", "8KuEzm=", defaultQueryExecutorManager0);
      Query query0 = defaultQuery0.bindValue("8KuEzm=", (Object) "8KuEzm=");
      ScriptQuery scriptQuery0 = new ScriptQuery(query0, (ComponentManager) null);
      Query query1 = escapeLikeParametersFilter0.filterQuery(scriptQuery0);
      SessionImplementor sessionImplementor0 = mock(SessionImplementor.class, new ViolatedAssumptionAnswer());
      ParameterMetadata parameterMetadata0 = new ParameterMetadata((OrdinalParameterDescriptor[]) null, (Map) null);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("8KuEzm=", (Object) null, sessionImplementor0, parameterMetadata0);
