...
public class AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest extends AbstractInstallPlanJob$ModifableExtensionPlanTree_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ExtensionId extensionId0 = new ExtensionId("^^H#56+&pGX`@!.!{x", "j %b/4V^4@e|/Z@`^@q");
      EmptyExtension emptyExtension0 = new EmptyExtension(extensionId0, "^^H#56+&pGX`@!.!{x");
      ...
      DefaultExtensionPlanAction defaultExtensionPlanAction0 = new DefaultExtensionPlanAction(emptyExtension0, treeSet0, extensionPlanAction_Action0, "j %b/4V^4@e|/Z@`^@q", false);
      DefaultVersionConstraint defaultVersionConstraint0 = new DefaultVersionConstraint("^^H#56+&pGX`@!.!{x");
