...
public class DefaultContentParser_ESTest extends DefaultContentParser_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      TreeSet<PygmentsParser> treeSet0 = new TreeSet<PygmentsParser>();
      PersistentSet persistentSet0 = new PersistentSet(sessionImplementor0, treeSet0);
      LocalDocumentReference localDocumentReference0 = new LocalDocumentReference(persistentSet0, "Release lock for %s.");
      // Undeclared exception!
      defaultContentParser0.parse("Release lock for %s.", (Syntax) null, (EntityReference) localDocumentReference0);
  }
}
