...
public class JarExtensionHandler_ESTest extends JarExtensionHandler_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(2210).when(installedExtension0).compareTo(any(org.xwiki.extension.Extension.class));
      doReturn(true).when(installedExtension0).isValid(anyString());
      treeSet0.add(installedExtension0);
      ...
      jarExtensionHandler0.upgrade((Collection<InstalledExtension>) treeSet0, localExtension0, "y!sydh$r PQ6:1gA", (Request) defaultRequest0);
  }
}
