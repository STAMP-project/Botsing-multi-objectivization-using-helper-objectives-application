...
public class HqlQueryExecutor_ESTest extends HqlQueryExecutor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      HashMap<NamedSQLQueryDefinition, ContextComponentManager> hashMap0 = new HashMap<NamedSQLQueryDefinition, ContextComponentManager>();
      ParameterMetadata parameterMetadata0 = new ParameterMetadata(ordinalParameterDescriptorArray0, hashMap0);
      CollectionFilterImpl collectionFilterImpl0 = new CollectionFilterImpl("136f6eIHGN", " H';9|", sessionImplementor0, parameterMetadata0);
      DefaultQuery defaultQuery0 = new DefaultQuery("Aq\"gQil{a>Wx4", hqlQueryExecutor0);
      Query query0 = defaultQuery0.bindValue((String) null, (Object) "8OC@KYjDf,V{l;6}#");
