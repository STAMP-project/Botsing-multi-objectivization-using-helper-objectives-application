...
public class AttachmentReference_ESTest extends AttachmentReference_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      AttachmentReference attachmentReference0 = new AttachmentReference("%[N`>QtuS$fAH", documentReference0);
      DocumentReference documentReference1 = new DocumentReference("%[N`>QtuS$fAH", "(s", "%[N`>QtuS$fAH");
