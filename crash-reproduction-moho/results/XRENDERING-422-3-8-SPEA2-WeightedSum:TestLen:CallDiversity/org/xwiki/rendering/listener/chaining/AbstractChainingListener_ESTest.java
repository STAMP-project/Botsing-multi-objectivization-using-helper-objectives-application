...
public class AbstractChainingListener_ESTest extends AbstractChainingListener_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn("BEGIN_QUOTATION", "BEGIN_QUOTATION").when(listenerChain1).toString();
      doReturn(consecutiveNewLineStateChainingListener0, emptyBlockChainingListener0).when(listenerChain1).getNextListener(nullable(java.lang.Class.class));
      groupStateChainingListener0.setListenerChain(listenerChain1);
      groupStateChainingListener0.onHorizontalLine(hashMap0);
      // Undeclared exception!
      groupStateChainingListener0.endFormat(format0, (Map<String, String>) null);
  }
}
